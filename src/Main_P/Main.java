...
- Create trip
- List trip
and make the methods for this functionality, (put the created trips in an ArrayList). Make it nice and working.
...
public class Main {
    ...
    UI.startMenu(); //Starts the Menu logic, this process will not finish until the User exits
